...
Function GeometryWars3($gamePlayTime, $launchUsing){

  $game_title = "GeometryWars3"
  $game_title_hub = "GeometryWars3"
  $testDescriptionPass = ""
  $testDescriptionFail = ""  
  $tc_status = $false
  $loop_status = $true
     ...
     switch($case_cnt){
        1 {          
            ...
            if($gameSelected -eq $true){  
                ReplaceTag –Document $Doc -FindText '<GeometryWars3_Step1>' -replacewithtext "Success"
        ...
        2{<#Check for Game Pass Badge 
          $Global:ElapsedTime = 10
            $UpdateScreenFound = Pattern_Verification -CapturedImage "GeometryWars3_Badge" -IconImage "GeometryWars3_Badge" 
            if($UpdateScreenFound -eq $true){
               
                ReplaceTag –Document $Doc -FindText '<GeometryWars3_Step2>' -replacewithtext "Success"
            }
            else
            {
                ReplaceTag –Document $Doc -FindText '<GeometryWars3_Step2>' -replacewithtext "NO Game Pass badge Found"
            }#>
            ...
            if($UpdateScreenFound -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<GeometryWars3_Update>' -replacewithtext "GeometryWars3 update triggered"
            }
            else
            {
                $case_cnt++
                ReplaceTag –Document $Doc -FindText '<GeometryWars3_Update>' -replacewithtext "No Update found"
            }                    
         }   
        ...
        3{
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<GeometryWars3_Step2>' -replacewithtext $testDescriptionFail
            } 
           } 
         ...
         4{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                ConsoleOne_CtrllerEnter
                ReplaceTag –Document $Doc -FindText '<GeometryWars3_Step3>' -replacewithtext "Success"
                $case_cnt ++ 
            }
            else
            {
                ...
                ReplaceTag –Document $Doc -FindText '<GeometryWars3_Step3>' -replacewithtext $testDescriptionFail
            }           
         }     
         ...
         5{        
            ...
            if($isChooseExpScreen -eq $true){
                ReplaceTag –Document $Doc -FindText '<GeometryWars3_Step4>' -replacewithtext "Success"
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<GeometryWars3_Step4>' -replacewithtext $testDescriptionFail
            }                 
         }            
        ...
        6{
            ...
            if($isGameQuit -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<GeometryWars3_Step5>' -replacewithtext "Success"            
            }
            else
            {
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<GeometryWars3_Step5>' -replacewithtext $testDescriptionFail               
            }            
        }
