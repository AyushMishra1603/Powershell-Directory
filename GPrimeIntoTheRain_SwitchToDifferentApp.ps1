Function GPrimeIntoTheRain_SwitchToDifferentApp($launchUsing,$gamePlayTime){

  $game_title = "GPrimeIntoTheRain_SwitchToDifferentApp"
  $game_title_hub= "GPrimeIntoTheRain_SwitchToDifferentApp"
  $testDescriptionPass = ""
  $testDescriptionFail = ""  
  $tc_status = $false
  $loop_status = $true
     ...
     switch($case_cnt){
        ...
        1 {          
            ...
            if($gameSelected -eq $true){  
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step1>' -replacewithtext "Success"
        ...
        2{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                ConsoleOne_CtrllerEnter
                    $case_cnt++
                    ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step2>' -replacewithtext "Success"
                } 
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step2>' -replacewithtext $testDescriptionFail
            } 
           } 
         ...
         3{        
            ...
            if($isChooseExpScreen -eq $true){
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step3>' -replacewithtext "Success"
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step3>' -replacewithtext $testDescriptionFail
            }                 
         }                       
        ...
        4 { ConsoleOne_CtrllerXbox
            ...
            if($gameSelected -eq $true)
            {  
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step4>' -replacewithtext "Success"
                Start-Sleep -Seconds 2                
                $case_cnt++
            }
            ...
            else
            {
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step4>' -replacewithtext $testDescriptionFail                  
            }      
          }
       ...
       5 { 
            ...
            if($IsApp -eq $true)
            {
              ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step5>' -replacewithtext "Success"
              $case_cnt++
            }
            else
            { 
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step5>' -replacewithtext $testDescriptionFail
            }
          }  
         6{   
            #Switch to GPrimeIntoTheRain and verifying that App Resumes exactly where it was left 
            ...
            {
              ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step6>' -replacewithtext "Success"
                $case_cnt++ 
            }
            else
            { 
                $case_cnt = 8                   
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step6>' -replacewithtext $testDescriptionFail               
            }       
         }
         7 {  
             # Switch to GPrimeIntoTheRain  after launching Youtube
            #Verify game has loaded
            Start-Sleep -Seconds 25
             ConsoleOne_CtrllerEnter 
            $Global:ElapsedTime = 90
            $IsGPrimeIntoTheRainPressMenu = Pattern_Verification -CapturedImage "GPrimeIntoTheRain_MenuScreen" -IconImage "GPrimeIntoTheRain_MenuScreen"           
            if($IsGPrimeIntoTheRainPressMenu -eq $true)
            { 
                Start-Sleep -Seconds 2
                ConsoleOne_CtrllerEnter  
            }
            ...
            {
              ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step7>' -replacewithtext "Success"
              $case_cnt++
            }
            else{
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step7>' -replacewithtext $testDescriptionFail
            }
          }
        ...
        8 {
            ...
            if($isGameQuit -eq $true,$isGameQuit1 -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step8>' -replacewithtext "Success"            
            }
            else
            {
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_SwitchToDifferentApp_Step8>' -replacewithtext $testDescriptionFail               
            }
