Function EmilyWantsToPlay_RestoreFromCS($launchUsing,$gamePlayTime){

  $game_title = "EmilyWantsToPlay_RestoreFromCS"
  $game_title_hub= "EmilyWantsToPlay_RestoreFromCS"
  $testDescriptionPass = ""
  $testDescriptionFail = ""  
  $tc_status = $false
  $loop_status = $true
     ...
     switch($case_cnt){
       ...
       1 {          
            ...
            if($gameSelected -eq $true){  
                ReplaceTag –Document $Doc -FindText '<EmilyWantsToPlay_RestoreFromCS_Step1>' -replacewithtext "Success"
        ...
        2{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                Start-Sleep -Seconds 2
                    $case_cnt++
                    ReplaceTag –Document $Doc -FindText '<EmilyWantsToPlay_RestoreFromCS_Step2>' -replacewithtext "Success"
                } 
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<EmilyWantsToPlay_RestoreFromCS_Step2>' -replacewithtext $testDescriptionFail
            } 
           } 
         ...
         3{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                ConsoleOne_CtrllerEnter
                ReplaceTag –Document $Doc -FindText '<EmilyWantsToPlay_RestoreFromCS_Step3>' -replacewithtext "Success"
                $case_cnt ++ 
            }
            else
            {
                ...
                ReplaceTag –Document $Doc -FindText '<EmilyWantsToPlay_RestoreFromCS_Step3>' -replacewithtext $testDescriptionFail
            }           
         }     
         ...
         4{        
            ...
            if($isChooseExpScreen -eq $true){
                ReplaceTag –Document $Doc -FindText '<EmilyWantsToPlay_RestoreFromCS_Step4>' -replacewithtext "Success"
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<EmilyWantsToPlay_RestoreFromCS_Step4>' -replacewithtext $testDescriptionFail
            }                 
         }            
       ...
       5 { #Go to Connected StandBy
         ...
         6{   
            ...
            if($isEmilyWantsToPlayResume -eq $true)
            { ConsoleOne_CtrllerEnter
              ReplaceTag –Document $Doc -FindText '<EmilyWantsToPlay_RestoreFromCS_Step5>' -replacewithtext "Success"
                $case_cnt = 8 
            }
            else
            { 
                $case_cnt++                   
                ReplaceTag –Document $Doc -FindText '<EmilyWantsToPlay_RestoreFromCS_Step5>' -replacewithtext $testDescriptionFail               
            }       
         } 
       7 {  
            ...
            {
              ReplaceTag –Document $Doc -FindText '<EmilyWantsToPlay_RestoreFromCS_Step6>' -replacewithtext "Success"
              $case_cnt++
            }
            else{
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<EmilyWantsToPlay_RestoreFromCS_Step6>' -replacewithtext $testDescriptionFail
            }
          }
         8 {
            ...
            if($isGameQuit -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<EmilyWantsToPlay_RestoreFromCS_Step7>' -replacewithtext "Success"            
            }
            else
            {
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<EmilyWantsToPlay_RestoreFromCS_Step7>' -replacewithtext $testDescriptionFail               
            }
