Function NBALive15_SwitchToDifferentGame($launchUsing,$gamePlayTime){

  $game_title = "NBALive15_SwitchToDifferentGame"
  $game_title_hub= "NBALive15_SwitchToDifferentGame"
  $testDescriptionPass = ""
  $testDescriptionFail = ""  
  $tc_status = $false
  $loop_status = $true
     ...
     switch($case_cnt){
        ...
        1 {          
            ...
            if($gameSelected -eq $true){  
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step1>' -replacewithtext "Success"
        ...
        2{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                ConsoleOne_CtrllerEnter 
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step2>' -replacewithtext "Success" 
                    $case_cnt++
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step2>' -replacewithtext $testDescriptionFail
            } 
           } 
        ...
        3{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                Start-Sleep -Seconds 4 
                ConsoleOne_CtrllerEnter
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step3>' -replacewithtext "Success"
                $case_cnt ++ 
            }
            else
            {
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step3>' -replacewithtext $testDescriptionFail
            }           
         }     
         ...
         4{        
            ...
            if($isChooseExpScreen -eq $true){
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step4>' -replacewithtext "Success"
                Start-Sleep -Seconds 1
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step4>' -replacewithtext $testDescriptionFail
            }                 
         }                       
        ...
        5 { ConsoleOne_CtrllerXbox
            ...
            if($gameSelected -eq $true)
            {  
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step5>' -replacewithtext "Success"
                Start-Sleep -Seconds 2                
                $case_cnt++
            }
            ...
            else
            {
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step5>' -replacewithtext $testDescriptionFail                  
            }      
          }
       ...
       6 { 
            ...
            if($IsFrozen -eq $true)
            {
              ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step6>' -replacewithtext "Success"
              $case_cnt++
            }
            else
            { 
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step6>' -replacewithtext $testDescriptionFail
            }
          }  
         7{   
            ...
            {
              ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step7>' -replacewithtext "Success"
                $case_cnt++ 
            }
            else
            { 
                $case_cnt = 9                   
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step7>' -replacewithtext $testDescriptionFail               
            }       
         }
         8 {  
             # Switch to NBALive15  after launching Frozen Free Fall
            ...
            {
              ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step8>' -replacewithtext "Success"
              $case_cnt++
            }
            else{
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step8>' -replacewithtext $testDescriptionFail
            }
          }
        ...
        9 {
            ...
            if($isGameQuit -eq $true,$isGameQuit1 -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step9>' -replacewithtext "Success"            
            }
            else
            {
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive15_SwitchToDifferentGame_Step9>' -replacewithtext $testDescriptionFail               
            }
