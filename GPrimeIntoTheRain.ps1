     ...
     switch($case_cnt){
        1 {          
            ...
            if($gameSelected -eq $true){  
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_Step1>' -replacewithtext "Success"
        ...
        2{<#Check for Game Pass Badge 
          $Global:ElapsedTime = 10
            $UpdateScreenFound = Pattern_Verification -CapturedImage "GPrimeIntoTheRain_Badge" -IconImage "GPrimeIntoTheRain_Badge" 
            if($UpdateScreenFound -eq $true){
               
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_Step2>' -replacewithtext "Success"
            }
            else
            {
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_Step2>' -replacewithtext "NO Game Pass badge Found"
            }#>
            ...
            if($UpdateScreenFound -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_Update>' -replacewithtext "GPrimeIntoTheRain update triggered"
            }
            else
            {
                $case_cnt++
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_Update>' -replacewithtext "No Update found"
            }                    
         }   
        3{
            #Default settings
            ...
            else
            {
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_Step2>' -replacewithtext $testDescriptionFail
            }           
         }     
         ...
         4{        
            ...
            if($isChooseExpScreen -eq $true){
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_Step3>' -replacewithtext "Success"
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_Step3>' -replacewithtext $testDescriptionFail
            }                 
         }            
        ...
        5{
            ...
            if($isGameQuit -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_Step4>' -replacewithtext "Success"            
            }
            else
            {
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_Step4>' -replacewithtext $testDescriptionFail               
            }            
        }
