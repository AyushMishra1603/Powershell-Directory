...
Function NightmareBoy_SwitchToDifferentApp($launchUsing){

  $game_title = "NightmareBoy_SwitchToDifferentApp"
  $game_title_hub= "NightmareBoy_SwitchToDifferentApp"
  $testDescriptionPass = ""
  $testDescriptionFail = ""  
  $tc_status = $false
  $loop_status = $true
     ...
     switch($case_cnt){
       ...
       1 {          
            ...
            if($gameSelected -eq $true){  
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_SwitchToDifferentApp_Step1>' -replacewithtext "Success"
        ...
        2{#Check for Game Pass Badge 
          $Global:ElapsedTime = 10
            ...
            if($UpdateScreenFound -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_SwitchToDifferentApp_Step2>' -replacewithtext "Success"
            }
            else
            {
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_SwitchToDifferentApp_Step2>' -replacewithtext "NO Game Pass badge Found"
            }#>
        ...
        3{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                #$isWhoAreYouScreen = WhoAreYouScreenHandle
                    ...
                    $case_cnt++
                    ReplaceTag –Document $Doc -FindText '<NightmareBoy_SwitchToDifferentApp_Step3>' -replacewithtext "Success"
                } 
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_SwitchToDifferentApp_Step3>' -replacewithtext $testDescriptionFail
            }  
         } 
         ...
         4{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_SwitchToDifferentApp_Step4>' -replacewithtext "Success"
                $case_cnt ++ 
            }
            else
            {
                ...
                Debug_Info 3 "Selections_Haven"
                $testDescriptionFail = "Unable to select the default settings for game " + $game_title
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_SwitchToDifferentApp_Step4>' -replacewithtext $testDescriptionFail
            }           
         }     
         ...
         5{     
            ...
            if($isChooseExpScreen -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_SwitchToDifferentApp_Step5>' -replacewithtext "Success"
                Start-Sleep -Seconds 5
            ...
            {              
                ...
                Debug_Info 3 "Selections_Haven"
                $testDescriptionFail = "Unable to select the default settings for game " + $game_title
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_SwitchToDifferentApp_Step5>' -replacewithtext $testDescriptionFail
            }                 
         }      
       ...
       7 { 
            ...
            if($isNightmareBoyGameplay -eq $true)
            {
              Start-Sleep -Seconds 5
                ...
                while ($counter -lt $gamePlayTime)
                {
                    ...
                    $counter = $counter + 12
              ReplaceTag –Document $Doc -FindText '<NightmareBoy_SwitchToDifferentApp_Step9>' -replacewithtext "Success"
              }
              $case_cnt++
            }
            else{
                ...
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_SwitchToDifferentApp_Step9>' -replacewithtext $testDescriptionFail
            }
          }
        ...
        10 {
            ...
            if($isGameQuit -eq $true,$isGameQuit1 -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_SwitchToDifferentApp_Step10>' -replacewithtext "Success"            
            }
            else
            {
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_SwitchToDifferentApp_Step10>' -replacewithtext $testDescriptionFail               
            }
