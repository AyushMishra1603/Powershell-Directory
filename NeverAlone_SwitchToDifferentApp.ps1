...
Function NeverAlone_SwitchToDifferentApp($launchUsing){

  $game_title = "NeverAlone_SwitchToDifferentApp"
  $game_title_hub= "NeverAlone_SwitchToDifferentApp"
  $testDescriptionPass = ""
  $testDescriptionFail = ""  
  $tc_status = $false
  $loop_status = $true
     ...
     switch($case_cnt){
       ...
       1 {          
            ...
            if($gameSelected -eq $true){  
                ReplaceTag –Document $Doc -FindText '<NeverAlone_SwitchToDifferentApp_Step1>' -replacewithtext "Success"
        ...
        2{#Check for Game Pass Badge 
          $Global:ElapsedTime = 10
            ...
            if($UpdateScreenFound -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<NeverAlone_SwitchToDifferentApp_Step2>' -replacewithtext "Success"
            }
            else
            {
                ReplaceTag –Document $Doc -FindText '<NeverAlone_SwitchToDifferentApp_Step2>' -replacewithtext "NO Game Pass badge Found"
            }#>
        ...
        3{
            ...
            $isNeverAlone_FirstScreen = Pattern_Verification -CapturedImage "NeverAlone_FirstScreen" -IconImage "NeverAlone_FirstScreen"
            
            if($isNeverAlone_FirstScreen -eq $true){
                ...
                #$isWhoAreYouScreen = WhoAreYouScreenHandle
                    ...
                    $case_cnt++
                    ReplaceTag –Document $Doc -FindText '<NeverAlone_SwitchToDifferentApp_Step3>' -replacewithtext "Success"
                } 
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<NeverAlone_SwitchToDifferentApp_Step3>' -replacewithtext $testDescriptionFail
            }  
         } 
         ...
         4{
            ...
            #Verify that if we have landed on Choose your experience
            $isNeverAlone_MenuScreen = Pattern_Verification -CapturedImage "NeverAlone_MenuScreen" -IconImage "NeverAlone_MenuScreen"

            if($isNeverAlone_MenuScreen -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<NeverAlone_SwitchToDifferentApp_Step4>' -replacewithtext "Success"
                $case_cnt ++ 
            }
            else
            {
                ...
                Debug_Info 3 "Selections_Haven"
                $testDescriptionFail = "Unable to select the default settings for game " + $game_title
                ReplaceTag –Document $Doc -FindText '<NeverAlone_SwitchToDifferentApp_Step4>' -replacewithtext $testDescriptionFail
            }           
         }     
         ...
         5{     
            ...
            #Verify that if we have landed on Choose your experience
            $isNeverAlone_GamePlay = Pattern_Verification -CapturedImage "NeverAlone_GamePlay" -IconImage "NeverAlone_GamePlay"
            
            if($isNeverAlone_GamePlay -eq $true){

                ReplaceTag –Document $Doc -FindText '<NeverAlone_SwitchToDifferentApp_Step5>' -replacewithtext "Success"
                Start-Sleep -Seconds 5
            ...
            {              
                ...
                Debug_Info 3 "Selections_Haven"
                $testDescriptionFail = "Unable to select the default settings for game " + $game_title
                ReplaceTag –Document $Doc -FindText '<NeverAlone_SwitchToDifferentApp_Step5>' -replacewithtext $testDescriptionFail
            }                 
         }      
       ...
       7 { 
         ...
         9 {  
            ...
            {
              ReplaceTag –Document $Doc -FindText '<NeverAlone_SwitchToDifferentApp_Step9>' -replacewithtext "Success"
              $case_cnt++
            }
            else{
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<NeverAlone_SwitchToDifferentApp_Step9>' -replacewithtext $testDescriptionFail
            }
          }
        ...
        10 {
            ...
            if($isGameQuit -eq $true,$isGameQuit1 -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<NeverAlone_SwitchToDifferentApp_Step10>' -replacewithtext "Success"            
            }
            else
            {
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<NeverAlone_SwitchToDifferentApp_Step10>' -replacewithtext $testDescriptionFail               
            }
