...
Function NightmareBoy ($gamePlayTime, $launchUsing){

  $game_title = "NightmareBoy"
  $game_title_hub = "Nightmare Boy"
  $testDescriptionPass = ""
  $testDescriptionFail = ""  
  $tc_status = $false
  $loop_status = $true
     ...
     switch($case_cnt){
        1{          
            ...
            if($gameSelected -eq $true){  
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_Step1>' -replacewithtext "Success"
        ...
        2{
          ...
          $Global:ElapsedTime = 10
            ...
            if($UpdateScreenFound -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_Step2>' -replacewithtext "Success"
            }
            else
            {
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_Step2>' -replacewithtext "NO Game Pass badge Found"
            }#>
        ...
        3{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                #$isWhoAreYouScreen = WhoAreYouScreenHandle
                    ...
                    $case_cnt++
                    ReplaceTag –Document $Doc -FindText '<NightmareBoy_Step3>' -replacewithtext "Success"
                } 
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_Step3>' -replacewithtext $testDescriptionFail
            }  
         } 
         ...
         4{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                Start-Sleep -Seconds 2
                ConsoleOne_CtrllerEnter
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_Step4>' -replacewithtext "Success"
                $case_cnt ++ 
            }
            else
            {
                ...
                Debug_Info 3 "Selections_Haven"
                $testDescriptionFail = "Unable to select the default settings for game " + $game_title
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_Step4>' -replacewithtext $testDescriptionFail
            }           
         }     
         ...
         5{     
            ...
            {              
                ...
                Debug_Info 3 "Selections_Haven"
                $testDescriptionFail = "Unable to select the default settings for game " + $game_title
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_Step5>' -replacewithtext $testDescriptionFail
            }                 
         }            
        ...
        6{
            ...
            if($isGameQuit -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_Step6>' -replacewithtext "Success"            
            }
            else
            {
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<NightmareBoy_Step6>' -replacewithtext $testDescriptionFail               
            }            
        }
