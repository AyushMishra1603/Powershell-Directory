...
Function Oceanhorn ($gamePlayTime, $launchUsing){

  $game_title = "Oceanhorn"
  $game_title_hub = "Oceanhorn"
  $testDescriptionPass = ""
  $testDescriptionFail = ""  
  $tc_status = $false
  $loop_status = $true
     ...
     switch($case_cnt){
        1{          
            ...
            if($gameSelected -eq $true){  
                ReplaceTag –Document $Doc -FindText '<Oceanhorn_Step1>' -replacewithtext "Success"
        ...
        2{
          ...
          $Global:ElapsedTime = 10
            ...
            if($UpdateScreenFound -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<Oceanhorn_Step2>' -replacewithtext "Success"
            }
            else
            {
                ReplaceTag –Document $Doc -FindText '<Oceanhorn_Step2>' -replacewithtext "NO Game Pass badge Found"
            }#>
        ...
        3{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                #$isWhoAreYouScreen = WhoAreYouScreenHandle
                    ...
                    $case_cnt++
                    ReplaceTag –Document $Doc -FindText '<Oceanhorn_Step3>' -replacewithtext "Success"
                } 
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<Oceanhorn_Step3>' -replacewithtext $testDescriptionFail
            }  
         } 
         ...
         4{
            ...
            #Verify that if we have landed on Choose your experience
            $isChooseAceCampaignScreen = Pattern_Verification -CapturedImage "Oceanhorn_MenuScreen" -IconImage "Oceanhorn_MenuScreen"
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                ConsoleOne_CtrllerEnter
                Start-Sleep -Seconds 2
                ReplaceTag –Document $Doc -FindText '<Oceanhorn_Step4>' -replacewithtext "Success"
                $case_cnt ++ 
            }
            else
            {
                ...
                Debug_Info 3 "Selections_Haven"
                $testDescriptionFail = "Unable to select the default settings for game " + $game_title
                ReplaceTag –Document $Doc -FindText '<Oceanhorn_Step4>' -replacewithtext $testDescriptionFail
            }           
         }     
         ...
         5{     
            ...
            if($isChooseExpScreen -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<Oceanhorn_Step5>' -replacewithtext "Success"
                Start-Sleep -Seconds 5
            ...
            {              
                ...
                Debug_Info 3 "Selections_Haven"
                $testDescriptionFail = "Unable to select the default settings for game " + $game_title
                ReplaceTag –Document $Doc -FindText '<Oceanhorn_Step5>' -replacewithtext $testDescriptionFail
            }                 
         }            
        ...
        6{
            ...
            if($isGameQuit -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<Oceanhorn_Step6>' -replacewithtext "Success"            
            }
            else
            {
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<Oceanhorn_Step6>' -replacewithtext $testDescriptionFail               
            }            
        }
