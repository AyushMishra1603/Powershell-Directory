Function GPrimeIntoTheRain_RestoreFromCS($launchUsing,$gamePlayTime){

  $game_title = "GPrimeIntoTheRain_RestoreFromCS"
  $game_title_hub= "GPrimeIntoTheRain_RestoreFromCS"
  $testDescriptionPass = ""
  $testDescriptionFail = ""  
  $tc_status = $false
  $loop_status = $true
     ...
     switch($case_cnt){
       ...
       1 {          
            ...
            if($gameSelected -eq $true){  
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_RestoreFromCS_Step1>' -replacewithtext "Success"
        ...
        2{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                ConsoleOne_CtrllerEnter   
                    $case_cnt++
                    ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_RestoreFromCS_Step2>' -replacewithtext "Success"
                } 
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_RestoreFromCS_Step2>' -replacewithtext $testDescriptionFail
            } 
           } 
         ...
         3{        
            ...
            if($isChooseExpScreen -eq $true){
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_RestoreFromCS_Step3>' -replacewithtext "Success"
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_RestoreFromCS_Step3>' -replacewithtext $testDescriptionFail
            }                 
         }            
       ...
       4 { #Go to Connected StandBy
        ...
        5{   
            ...
            if($isGPrimeIntoTheRainResume -eq $true)
            { ConsoleOne_CtrllerEnter
              ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_RestoreFromCS_Step4>' -replacewithtext "Success"
                $case_cnt = 8 
            }
            else
            { 
                $case_cnt++                   
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_RestoreFromCS_Step4>' -replacewithtext $testDescriptionFail               
            }       
         } 
       6 {  
           #Verify game has loaded, Menu is visible
           Start-Sleep -Seconds 25
            ...
            {
              ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_RestoreFromCS_Step5>' -replacewithtext "Success"
              $case_cnt++
            }
            else{
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_RestoreFromCS_Step5>' -replacewithtext $testDescriptionFail
            }
          }
         7 {
            ...
            if($isGameQuit -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_RestoreFromCS_Step6>' -replacewithtext "Success"            
            }
            else
            {
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<GPrimeIntoTheRain_RestoreFromCS_Step6>' -replacewithtext $testDescriptionFail               
            }
