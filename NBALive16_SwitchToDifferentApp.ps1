     ...
     switch($case_cnt){
        ...
        1 {          
            ...
            if($gameSelected -eq $true){  
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step1>' -replacewithtext "Success"
        ...
        2{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                ConsoleOne_CtrllerEnter  
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step2>' -replacewithtext "Success"
                    $case_cnt++
                } 
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step2>' -replacewithtext $testDescriptionFail
            } 
           } 
         ...
         3{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                Start-Sleep -Seconds 2
                ConsoleOne_CtrllerEnter
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step3>' -replacewithtext "Success"
                $case_cnt ++ 
            }
            else
            {
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step3>' -replacewithtext $testDescriptionFail
            }           
         }     
         ...
         4{        
            ...
            if($isChooseExpScreen -eq $true){
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step4>' -replacewithtext "Success"
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step4>' -replacewithtext $testDescriptionFail
            }                 
         }                       
        ...
        5 { ConsoleOne_CtrllerXbox
            ...
            if($gameSelected -eq $true)
            {  
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step5>' -replacewithtext "Success"
                Start-Sleep -Seconds 2                
                $case_cnt++
            }
            ...
            else
            {
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step5>' -replacewithtext $testDescriptionFail                  
            }      
          }
       ...
       6 { 
            ...
            if($IsApp -eq $true)
            {
              ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step6>' -replacewithtext "Success"
              $case_cnt++
            }
            else
            { 
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step6>' -replacewithtext $testDescriptionFail
            }
          }  
         7{   
            ...
            {
              ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step7>' -replacewithtext "Success"
                $case_cnt++ 
            }
            else
            { 
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step7>' -replacewithtext $testDescriptionFail               
            }       
         }
         8 {  
            ...
            {
              ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step8>' -replacewithtext "Success"
              $case_cnt++
            }
            else{
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step8>' -replacewithtext $testDescriptionFail
            }
          }
        ...
        9 {
            ...
            if($isGameQuit -eq $true,$isGameQuit1 -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step9>' -replacewithtext "Success"            
            }
            else
            {
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<NBALive16_SwitchToDifferentApp_Step9>' -replacewithtext $testDescriptionFail               
            }
