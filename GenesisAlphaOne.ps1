...
Function GenesisAlphaOne($gamePlayTime, $launchUsing){

  $game_title = "GenesisAlphaOne"
  $game_title_hub = "GenesisAlphaOne"
  $testDescriptionPass = ""
  $testDescriptionFail = ""  
  $tc_status = $false
  $loop_status = $true
     ...
     switch($case_cnt){
        1 {          
            ...
            if($gameSelected -eq $true){  
                ReplaceTag –Document $Doc -FindText '<GenesisAlphaOne_Step1>' -replacewithtext "Success"
        ...
        2{<#Check for Game Pass Badge 
          $Global:ElapsedTime = 10
            $UpdateScreenFound = Pattern_Verification -CapturedImage "GenesisAlphaOne_Badge" -IconImage "GenesisAlphaOne_Badge" 
            if($UpdateScreenFound -eq $true){
               
                ReplaceTag –Document $Doc -FindText '<GenesisAlphaOne_Step2>' -replacewithtext "Success"
            }
            else
            {
                ReplaceTag –Document $Doc -FindText '<GenesisAlphaOne_Step2>' -replacewithtext "NO Game Pass badge Found"
            }#>
            ...
            if($UpdateScreenFound -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<GenesisAlphaOne_Update>' -replacewithtext "GenesisAlphaOne update triggered"
            }
            else
            {
                $case_cnt++
                ReplaceTag –Document $Doc -FindText '<GenesisAlphaOne_Update>' -replacewithtext "No Update found"
            }                    
         }   
        ...
        3{
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<GenesisAlphaOne_Step2>' -replacewithtext $testDescriptionFail
            } 
           } 
         ...
         4{
            ...
            if($isChooseAceCampaignScreen -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<GenesisAlphaOne_Step3>' -replacewithtext "Success"
                $case_cnt ++ 
            }
            else
            {
                ...
                ReplaceTag –Document $Doc -FindText '<GenesisAlphaOne_Step3>' -replacewithtext $testDescriptionFail
            }           
         }     
         ...
         5{        
            ...
            if($isChooseExpScreen -eq $true){
                ReplaceTag –Document $Doc -FindText '<GenesisAlphaOne_Step4>' -replacewithtext "Success"
            ...
            {              
                ...
                ReplaceTag –Document $Doc -FindText '<GenesisAlphaOne_Step4>' -replacewithtext $testDescriptionFail
            }                 
         }            
        ...
        6{
            ...
            if($isGameQuit -eq $true){
                ...
                ReplaceTag –Document $Doc -FindText '<GenesisAlphaOne_Step5>' -replacewithtext "Success"            
            }
            else
            {
                $case_cnt = 20
                ...
                ReplaceTag –Document $Doc -FindText '<GenesisAlphaOne_Step5>' -replacewithtext $testDescriptionFail               
            }            
        }
